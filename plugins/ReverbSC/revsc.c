...
static const SPFLOAT reverbParams[8][4] = {
    { (2473.0f / DEFAULT_SRATE), 0.0010f, 3.100f,  1966.0f },
    ...
    { (1933.0f / DEFAULT_SRATE), 0.0006f, 3.221f, 14417.0f }
};
...
int sp_revsc_compute(sp_data *sp, sp_revsc *p, SPFLOAT *in1, SPFLOAT *in2, SPFLOAT *out1, SPFLOAT *out2)
{
    ...
    for (n = 0; n < 8; n++) {
        ...
        a2 = frac * frac; a2 -= 1.0; a2 *= (1.0f / 6.0f);
