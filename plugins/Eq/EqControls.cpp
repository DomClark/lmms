...
EqControls::EqControls( EqEffect *effect ) :
	...
	m_effect( effect ),
	m_inGainModel( 0.0f, -60.0f, 20.0f, 0.01f, this, tr( "Input gain") ),
	m_outGainModel( -.0f, -60.0f, 20.0f, 0.01f, this, tr( "Output gain" ) ),
	m_lowShelfGainModel(  0.0f , -18, 18, 0.001f, this, tr( "Low-shelf gain" ) ),
	m_para1GainModel( 0.0f , -18, 18, 0.001f, this, tr( "Peak 1 gain" ) ),
	m_para2GainModel( 0.0f , -18, 18, 0.001f, this, tr( "Peak 2 gain" ) ),
	m_para3GainModel( 0.0f , -18, 18, 0.001f, this, tr( "Peak 3 gain" ) ),
	m_para4GainModel( 0.0f , -18, 18, 0.001f, this, tr( "Peak 4 gain" ) ),
	m_highShelfGainModel( 0.0f , -18, 18, 0.001f, this, tr( "High-shelf gain" ) ),
	m_hpResModel( 0.707f,0.003f, 10.0f , 0.001f, this, tr( "HP res" ) ),
	m_lowShelfResModel( 0.707f, 0.55f, 10.0f , 0.001f, this , tr( "Low-shelf res" ) ),
	...
	m_highShelfResModel( 0.707f, 0.55f, 10.0f , 0.001f, this , tr( "High-shelf res" ) ),
	m_lpResModel( 0.707f,0.003f, 10.0f , 0.001f, this , tr( "LP res" ) ),
	m_hpFeqModel( 31.0f, 20.0f, 20000, 0.001f, this , tr( "HP freq" ) ),
	m_lowShelfFreqModel( 80.0f, 20.0f, 20000, 0.001f, this , tr( "Low-shelf freq" ) ),
	m_para1FreqModel( 120.0f, 20.0f, 20000, 0.001f, this , tr( "Peak 1 freq" ) ),
	m_para2FreqModel( 250.0f, 20.0f, 20000, 0.001f, this, tr( "Peak 2 freq" )  ),
	m_para3FreqModel( 2000.0f, 20.0f, 20000, 0.001f, this , tr( "Peak 3 freq" ) ),
	m_para4FreqModel( 4000.0f, 20.0f, 20000, 0.001f, this , tr( "Peak 4 freq" ) ),
	m_highShelfFreqModel( 12000.0f, 20.0f, 20000, 0.001f, this , tr( "High-shelf freq" ) ),
	m_lpFreqModel( 18000.0f, 20.0f, 20000, 0.001f, this , tr( "LP freq" ) ),
