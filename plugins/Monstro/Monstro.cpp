...
MonstroInstrument::MonstroInstrument( InstrumentTrack * _instrument_track ) :
		...
		m_osc1Vol( 33.0f, 0.0f, 200.0f, 0.1f, this, tr( "Osc 1 volume" ) ),
		m_osc1Pan( 0.0f, -100.0f, 100.0f, 0.1f, this, tr( "Osc 1 panning" ) ),
		m_osc1Crs( 0.0f, -24.0f, 24.0f, 1.0f, this, tr( "Osc 1 coarse detune" ) ),
		m_osc1Ftl( 0.0f, -100.0f, 100.0f, 1.0f, this, tr( "Osc 1 fine detune left" ) ),
		m_osc1Ftr( 0.0f, -100.0f, 100.0f, 1.0f, this, tr( "Osc 1 fine detune right" ) ),
		m_osc1Spo( 0.0f, -180.0f, 180.0f, 0.1f, this, tr( "Osc 1 stereo phase offset" ) ),
		m_osc1Pw( 50.0f, PW_MIN, PW_MAX, 0.01f, this, tr( "Osc 1 pulse width" ) ),
		m_osc1SSR( false, this, tr( "Osc 1 sync send on rise" ) ),
		m_osc1SSF( false, this, tr( "Osc 1 sync send on fall" ) ),

		m_osc2Vol( 33.0f, 0.0f, 200.0f, 0.1f, this, tr( "Osc 2 volume" ) ),
		m_osc2Pan( 0.0f, -100.0f, 100.0f, 0.1f, this, tr( "Osc 2 panning" ) ),
		m_osc2Crs( 0.0f, -24.0f, 24.0f, 1.0f, this, tr( "Osc 2 coarse detune" ) ),
		m_osc2Ftl( 0.0f, -100.0f, 100.0f, 1.0f, this, tr( "Osc 2 fine detune left" ) ),
		m_osc2Ftr( 0.0f, -100.0f, 100.0f, 1.0f, this, tr( "Osc 2 fine detune right" ) ),
		m_osc2Spo( 0.0f, -180.0f, 180.0f, 0.1f, this, tr( "Osc 2 stereo phase offset" ) ),
		m_osc2Wave( this, tr( "Osc 2 waveform" ) ),
		m_osc2SyncH( false, this, tr( "Osc 2 sync hard" ) ),
		m_osc2SyncR( false, this, tr( "Osc 2 sync reverse" ) ),

		m_osc3Vol( 33.0f, 0.0f, 200.0f, 0.1f, this, tr( "Osc 3 volume" ) ),
		m_osc3Pan( 0.0f, -100.0f, 100.0f, 0.1f, this, tr( "Osc 3 panning" ) ),
		m_osc3Crs( 0.0f, -24.0f, 24.0f, 1.0f, this, tr( "Osc 3 coarse detune" ) ),
		m_osc3Spo( 0.0f, -180.0f, 180.0f, 0.1f, this, tr( "Osc 3 Stereo phase offset" ) ),
		m_osc3Sub( 0.0f, -100.0f, 100.0f, 0.1f, this, tr( "Osc 3 sub-oscillator mix" ) ),
		...
		m_lfo1Rate( 1.0f, 0.1f, 10000.0f, 0.1f, 10000.0f, this, tr( "LFO 1 rate" ) ),
		m_lfo1Phs( 0.0f, -180.0f, 180.0f, 0.1f, this, tr( "LFO 1 phase" ) ),

		m_lfo2Wave( this, tr( "LFO 2 waveform" ) ),
		m_lfo2Att( 0.0f, 0.0f, 2000.0f, 1.0f, 2000.0f, this, tr( "LFO 2 attack" ) ),
		m_lfo2Rate( 1.0f, 0.1f, 10000.0f, 0.1f, 10000.0f, this, tr( "LFO 2 rate" ) ),
		m_lfo2Phs( 0.0f	, -180.0f, 180.0f, 0.1f, this, tr( "LFO 2 phase" ) ),
