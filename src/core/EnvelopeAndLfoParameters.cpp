...
EnvelopeAndLfoParameters::EnvelopeAndLfoParameters(
	...
	Model( _parent ),
	m_used( false ),
	m_predelayModel( 0.0f, 0.0f, 2.0f, 0.001f, this, tr( "Env pre-delay" ) ),
	m_attackModel( 0.0f, 0.0f, 2.0f, 0.001f, this, tr( "Env attack" ) ),
	m_holdModel( 0.5f, 0.0f, 2.0f, 0.001f, this, tr( "Env hold" ) ),
	m_decayModel( 0.5f, 0.0f, 2.0f, 0.001f, this, tr( "Env decay" ) ),
	m_sustainModel( 0.5f, 0.0f, 1.0f, 0.001f, this, tr( "Env sustain" ) ),
	m_releaseModel( 0.1f, 0.0f, 2.0f, 0.001f, this, tr( "Env release" ) ),
	m_amountModel( 0.0f, -1.0f, 1.0f, 0.005f, this, tr( "Env mod amount" ) ),
	...
	m_pahdBufSize( 0 ),
	m_rBufSize( 0 ),
	m_lfoPredelayModel( 0.0f, 0.0f, 1.0f, 0.001f, this, tr( "LFO pre-delay" ) ),
	m_lfoAttackModel( 0.0f, 0.0f, 1.0f, 0.001f, this, tr( "LFO attack" ) ),
	m_lfoSpeedModel( 0.1f, 0.001f, 1.0f, 0.0001f,
				SECS_PER_LFO_OSCILLATION * 1000.0f, this,
							tr( "LFO frequency" ) ),
	m_lfoAmountModel( 0.0f, -1.0f, 1.0f, 0.005f, this, tr( "LFO mod amount" ) ),
