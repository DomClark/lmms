...
LfoController::LfoController( Model * _parent ) :
	...
	m_baseModel( 0.5f, 0.0f, 1.0f, 0.001f, this, tr( "Base value" ) ),
	m_speedModel( 2.0f, 0.01f, 20.0f, 0.0001f, 20000.0f, this, tr( "Oscillator speed" ) ),
	m_amountModel( 1.0f, -1.0f, 1.0f, 0.005f, this, tr( "Oscillator amount" ) ),
	m_phaseModel( 0.0f, 0.0f, 360.0f, 4.0f, this, tr( "Oscillator phase" ) ),
